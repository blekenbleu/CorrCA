...
- fname_calib.ppm fname_poly_red.txt fname_poly_blue.txt
- Based on RGB calibration image, the program estimates correction polynomials
  for red and blue channels and saves them to chosen txt files
- EXAMPLE: data/_MG_7626.pgm data/_MG_7626_polyR.txt data/_MG_7626_polyB.txt

2) Six input arguments: 
- fname.ppm fname_poly_red.txt fname_poly_blue.txt fname_raw_red_corr.pgm fname_raw_green_corr.pgm fname_raw_blue_corr.pgm
- Read RGB image that needs correction, reads correction polynomials and corrects the image.
  Three corrected channels are saved as separate R, G and B PGM files.
...
2a) Four arguments: as for six, except output 3 channels as a single RGB interleaved PPM.
...
- Runs all the circuit: first it builds the correction polynomials based on calibration raw image,
 it corrects the calibration image and then it corrects all the images that were taken with the same camera settings.
 ...
 Correction polynomials are not saved, for this, use point 1).
- EXAMPLE: data/_MG_7626.pgm data/_MG_7626_R_corr.pgm data/_MG_7626_G_corr.pgm data/_MG_7626_B_corr.pgm
	 data/_MG_7626_dist.txt data/_MG_7626_corr.txt
	 data/_MG_7628.pgm data/_MG_7628_R_corr.pgm data/_MG_7628_G_corr.pgm data/_MG_7628_B_corr.pgm
